let
    ...
    Source = Csv.Document(File.Contents("C:\Users\Yoshimasa Kumano\OneDrive - パースペクティブ株式会社\ドキュメント\GitHub\DCF2PCV\DCF_202510_中締\TBL_SNRYKMK.txt"),[Delimiter=",", Columns=8, Encoding=65001, QuoteStyle=QuoteStyle.None]),
    ...
    // NULLを"NULL"文字列に変換（CSVで""として出力されるように）
