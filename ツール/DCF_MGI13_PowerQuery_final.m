let
    ...
    AddedMGI13MSZKC = Table.AddColumn(AddedASEQN, "MGI13MSZKC", each [InputCol2_FileKey], type text),
    AddedMGI13MSZKK = Table.AddColumn(AddedMGI13MSZKC, "MGI13MSZKK", each null, type text),
    AddedMGI13KSZKK = Table.AddColumn(AddedMGI13MSZKK, "MGI13KSZKK", each [InputCol8_KanaName], type text),
